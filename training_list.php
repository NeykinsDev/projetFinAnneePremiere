...
<body>
    ...
    <div class="main_container">
        <div class="search">
            <form  method="POST">
                            <input type="text" name="search" placeholder="Formation">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="training_form.php?edit=<?php echo $row['Intitule']; ?>">
                    <span class="material-icons-outlined" style="color:blue">
                    edit
                    </span>
                    </a>
                        <a href="controller/process_training.ctl.php?delete=<?php echo $row['Intitule'] ?>" >
            ...
            <a class="btn btn-secondary" href="training_form.php"> New Data</a>
        </div>
    </div>
